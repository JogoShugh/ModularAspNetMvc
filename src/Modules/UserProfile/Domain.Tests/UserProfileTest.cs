...
namespace Core.Modules.UserProfile.Core.Tests
{
    ...
    public class UserProfileTest : BaseTestScript
    {
        ...
        {
            MessagesScriptAsXml =
                @"<Message type='Core.Modules.UserProfile.Messages.Commands.UserProfileUpdate, Core.Modules.UserProfile.Messages, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' messageType='Message'>{""Name"":""Josh"",""Intro"":""Dev at Lockheed""}</Message>
<Message type='Core.Infrastructure.Messaging.TypedMessageResponse`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]], Core.Infrastructure, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' messageType='Response'>{""Data"":""Thank you Josh Dev at Lockheed"",""Success"":true}</Message>
<Message type='Core.Modules.UserProfile.Messages.Commands.UserProfileUpdate, Core.Modules.UserProfile.Messages, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' messageType='Message'>{""Name"":""Josh"",""Intro"":""Dev at Lockheed""}</Message>
<Message type='Core.Infrastructure.Messaging.TypedMessageResponse`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]], Core.Infrastructure, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' messageType='Response'>{""Data"":""Thank you Josh Dev at Lockheed"",""Success"":true}</Message>";
        }
